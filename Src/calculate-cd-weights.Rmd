...
There are 39,903 blocks in the 7 counties. 17,547 of these intersect partially or completely with one or more community districts. 16339 intersect with only one community district, 1,108 intersect with two, 1,108 intersect with three, and 9 intersect with four. Note that `16339*1 + 1108*2 + 91*3 + 9*4 = 18864`.
