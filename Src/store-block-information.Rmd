...
A census block is the smallest geographical unit used by the United States Census Bureau for tabulation of 100-percent data. There are separate files for each individual county.
